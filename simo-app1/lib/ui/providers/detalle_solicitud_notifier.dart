...
class DetalleSolicitudNotifier extends ChangeNotifier {
  ...
  Future<void> marcarCompleto() async {
    ...
    // TODO: Llamar al use case correspondiente cuando el backend esté listo
    // final result = await _completarSolicitud(_state.detalle!.id);
    await Future.delayed(const Duration(seconds: 1)); // simulación temporal
