...
class _OpcionesScreenState extends State<OpcionesScreen>
  ...
  final List<Map<String, dynamic>> dispositivos = [
    {'label': 'Celular', 'icon': 'assets/imagenes/opciones/celular.png'},
    {'label': 'Laptop', 'icon': 'assets/imagenes/opciones/laptop.png'},
    {'label': 'Pantallas o TV', 'icon': 'assets/imagenes/opciones/tv.png'},
    {
      'label': 'Refrigerador',
      'icon': 'assets/imagenes/opciones/refrigerador.png',
    },
    {'label': 'Cables', 'icon': 'assets/imagenes/opciones/cables.png'},
    {
      'label': 'Otros Dispositivos',
      'icon': 'assets/imagenes/opciones/otrosdispositivos.png',
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: SimoBottomNav(currentIndex: 1, onTap: (index) {}),
    );
  }
  ...
  Widget _buildGridItem(int index) {
    if (index >= dispositivos.length) return const SizedBox();
    final disp = dispositivos[index];
    return DispositivoIconCard(
      label: disp['label'],
      imagePath: disp['icon'],
      isSelected: selectedDispositivo == disp['label'],
      onTap: () {
        if (disp['label'] == 'Otros Dispositivos') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const BusquedaScreen()),
          );
          ...
          setState(() {
            if (selectedDispositivo == disp['label']) {
              selectedDispositivo = null;
              selectedIconPath = null;
            } else {
              selectedDispositivo = disp['label'];
              selectedIconPath = disp['icon'];
            }
          });
        }
      },
